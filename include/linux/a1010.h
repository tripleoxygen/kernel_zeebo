/* include/linux/a1010.h - a1010 voice processor driver
 *
 * Based on include/linux/A1010.h (Copyright (C) 2009 HTC Corporation.)
...
#ifndef __LINUX_A1010_H
#define __LINUX_A1010_H

#include <linux/ioctl.h>

enum A1010_PathID {
	A1010_PATH_SUSPEND,
	A1010_PATH_EARCOUPLE,
	A1010_PATH_SPEAKER,
	A1010_PATH_SPKSLIDE,
};

/* indicates if A1010_set_config() performs a full configuration or only
 * a voice processing algorithm configuration */
/* IOCTLs for Audience A1010 */
#define A1010_IOCTL_MAGIC 'u'

#define A1010_SET_CONFIG   _IOW(A1010_IOCTL_MAGIC, 0x02, enum A1010_PathID)

/* For Diag */
#define A1010_READ_DATA		_IOR(A1010_IOCTL_MAGIC, 0x52, unsigned)
#define A1010_WRITE_MSG		_IOW(A1010_IOCTL_MAGIC, 0x53, unsigned)
#define A1010_SYNC_CMD		_IO(A1010_IOCTL_MAGIC, 0x54)
...
#define A1010_msg_VP_ON		0x801C0001
#define A1010_msg_VP_OFF	0x801C0000
...
#define A1010_msg_BOOT		0x0001
#define A1010_msg_BOOT_ACK	0x01

/* general definitions */
#define TIMEOUT			20 /* ms */
#define RETRY_CNT		5
#define POLLING_RETRY_CNT	3
#define A1010_ERROR_CODE	0xffff
#define A1010_SLEEP		0
#define A1010_ACTIVE		1
#define A1010_CMD_FIFO_DEPTH	64
#define ERROR			0xffffffff

enum A1010_config_mode {
	A1010_CONFIG_FULL,
	A1010_CONFIG_VP
};
